package com.example.learningoutcomes.swipeListView;
...
//				final int downPosition = mDownPosition;
	...
	public void clickAnimation() {
		...
		.setDuration(mAnimationTime)
		.setListener(null);
		View visibleView, invisibleView; //Currently visible view and invisible view
		visibleView = (View) mDownView.findViewById(R.id.textDescription);
		invisibleView = (View) mDownView.findViewById(R.id.buttonDescription);
		if(visibleView.getVisibility() != View.VISIBLE)
			visibleView.setVisibility(View.VISIBLE);
		else
			visibleView.setVisibility(View.INVISIBLE);
		if(invisibleView.getVisibility() == View.INVISIBLE)
